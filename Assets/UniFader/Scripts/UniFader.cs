...
namespace MB.UniFader
{
    ...
    public class UniFader : MonoBehaviour
    {
        ...
        [SerializeField] private bool usedAsInstance = true;
        ...
        public bool UsedAsInstance => usedAsInstance;
        ...
        public static UniFader Instance
        {
            get
            {
                ...
                _instance = FindObjectsOfType<UniFader>()
                    .FirstOrDefault(t => t.fadeTarget && t.usedAsInstance); 
                if (_instance) return _instance;
                
                _instance = new GameObject("UniFader").AddComponent<UniFader>();
                return _instance;
            }
        }
        ...
        void InitializeFadeTarget()
        {
            ...
            if (Application.isPlaying)
            {
                ...
                {
                    Destroy(gameObject);
                    Destroy(fadeTarget.GetComponentInParent<Canvas>().gameObject);
                }
            }
        }
        ...
        {
            yield return ExecFade(true, defaultDuration, null);
        }
        ...
        {
            yield return ExecFade(false, defaultDuration, null);
        }
