...
namespace MB.UniFader
{
    ...
    public class UniFaderEditor : Editor
    {
        ...
        private SerializedProperty usedByDefault;
        ...
        void OnEnable()
        {
            ...
            usedByDefault = serializedObject.FindProperty("usedByDefault");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(usedByDefault);
        ...
        bool CheckIfMultiFaderHasDefaultSettings()
        {
            var faderHasUsedByDefaultCount =
                FindObjectsOfType<UniFader>().Count(t => t.UsedByDefault);
